  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#1b1b1b] text-white">
        <p>Loading...</p>{" "}
        {/* FIND LOADING COMPONENTS SA MGA LIBRARY STACK LATER */}
      </div>
    );
  }
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="min-h-screen flex flex-col items-center justify-center relative">
        ...
        />
        <h1 className="text-white sm:text-9xl text-4xl font-bold z-10">
          {" "}
          TOGETHER, FOREVER
        </h1>
      </div>
      ...
      <div className="bg-[#1b1b1b] py-12">
        <h1 className="text-[#4AEE98] text-3xl text-center font-bold">
      ...
      <div className="bg-[#1b1b1b] flex flex-row justify-around items-center py-16">
        <div className="flex items-center justify-center flex-col gap-2">
          ...
          <p className="text-[#4AEE98] sm:text-6xl m-0 text-2xl font-bold">
            {stats?.activeMembers || "0"}+
          </p>
          <p className="text-[#4AEE98] m-0 text-sm sm:text-xl">
            Active Members
          </p>
        </div>
        <div className="flex items-center justify-center flex-col gap-2">
      ...
      <div className="relative w-full py-16 overflow-hidden ">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center ">
          <h1 className="sm:text-6xl text-2xl font-bold mb-8 text-white">
