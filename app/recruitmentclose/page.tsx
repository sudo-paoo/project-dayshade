...
export default function ClosedRecruitment() {
  ...
  <div className="min-h-screen bg-gradient-to-br from-[var(--background)/60] to-[var(--sidebar)/30] flex items-center justify-center relative overflow-hidden">
      ...
      >
        <h1 className="text-8xl font-bold text-white mb-4 tracking-tight">CLOSED</h1>
        <h2 className="text-xl text-white/90 mb-2 font-medium">Oops! Looks like we’re currently not looking for members!</h2>
        <p className="text-white/70 mb-8 text-sm">Follow Programmers’ Den official Facebook page to get news on when recruitment is live</p>
        <Link href="/">
           <Button className='mt-4 px-4 md:px-6 py-6 bg-gradient-to-r from-[#67FFAF] via-100% to-[#0D4D2C] rounded-full hover:bg-pd-green-dark cursor-pointer text-white font-bold text-xl'>Take Me Home</Button>
        </Link>
      </GlassContainer>
    </div>
  )
